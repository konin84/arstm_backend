...
class School(models.Model):
    ...
    director_name = models.CharField(max_length=255, verbose_name="Nom du directeur", blank=True)
    ...
    founded_year = models.PositiveSmallIntegerField(verbose_name="Année de création", blank=True, null=True)
    accreditation = models.CharField(max_length=255, verbose_name="Accréditation", blank=True)
